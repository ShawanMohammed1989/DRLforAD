...
class CustomModel(TFModelV2):
    ...
    def forward(self, input_dict, state, seq_lens):
        ...
        """
        image = tf.saturate_cast(input_dict['obs'], tf.float32)
        
        self.last_vae_image_input = image
        
        mean, _, vae_feature_map_extraction = self.vae_encoder([image])
    ...
    def import_encoder_from_h5(self, h5_file: str) -> None:
        self.vae_encoder.load_weights(h5_file)
